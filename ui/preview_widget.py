...
class PreviewWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self._placeholder.setMinimumSize(400, 500)
        ...
        self.thumbnail_list.setFixedWidth(80)
        ...
        self.preview_label.setMinimumSize(350, 500)
        ...
        for i, path in enumerate(self._image_paths):
            try:
                ...
                if not pixmap.isNull():
                    scaled = pixmap.scaled(80, 100, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
                    item = QListWidgetItem()
                    item.setText(f'{i + 1}')
